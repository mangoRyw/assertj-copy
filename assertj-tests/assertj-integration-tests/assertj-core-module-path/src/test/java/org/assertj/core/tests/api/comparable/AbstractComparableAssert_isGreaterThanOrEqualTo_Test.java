 ...
 */
package org.assertj.core.tests.api.comparable;
...
/**
 * Tests for <code>{@link AbstractComparableAssert#isGreaterThanOrEqualTo(Comparable)}</code>.
 * 
 * @author Alex Ruiz
 */
class AbstractComparableAssert_isGreaterThanOrEqualTo_Test extends AbstractComparableAssertBaseTest {
