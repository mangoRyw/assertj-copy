 ...
 */
package org.assertj.core.tests.api.atomic.referencearray;
...
import static org.assertj.core.tests.testkit.NeverEqualComparator.NEVER_EQUALS_STRING;
...
class AtomicReferenceArrayAssert_usingComparatorForType_Test extends AtomicReferenceArrayAssertBaseTest {
  ...
  void should_fail_because_of_comparator_set_last() {
    ...
    then(error).hasMessage(format("%nExpecting Object[]:%n"
                                  ...
                                  + "when comparing values using field/property by field/property comparator on all fields/properties%n"
                                  + "Comparators used:%n"
                                  + "- for elements fields (by type): {Double -> DoubleComparator[precision=1.0E-15], Float -> FloatComparator[precision=1.0E-6], String -> org.assertj.core.tests.testkit.NeverEqualComparator, Path -> lexicographic comparator (Path natural order)}%n"
