 ...
 */
package org.assertj.core.tests.api.double2darray;
...
/**
 * Tests for <code>{@link Double2DArrayAssert#isNotEmpty()}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Double2DArrayAssert isNotEmpty")
class Double2DArrayAssert_isNotEmpty_Test extends Double2DArrayAssertBaseTest {
