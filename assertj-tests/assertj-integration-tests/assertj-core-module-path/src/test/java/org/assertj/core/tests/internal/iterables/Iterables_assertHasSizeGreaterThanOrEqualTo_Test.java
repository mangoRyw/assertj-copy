...
class Iterables_assertHasSizeGreaterThanOrEqualTo_Test extends IterablesBaseTest {
  ...
  void should_fail_if_actual_is_null() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> iterables.assertHasSizeGreaterThanOrEqualTo(someInfo(), null,
                                                                                                                 6))
  ...
  void should_fail_if_size_of_actual_is_not_greater_than_or_equal_to_boundary() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> iterables.assertHasSizeGreaterThanOrEqualTo(someInfo(),
                                                                                                                 actual, 6))
