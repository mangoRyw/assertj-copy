...
import org.assertj.core.api.AbstractTemporalAssertBaseTest;
import org.assertj.core.api.ConcreteTemporalAssert;
...
class TemporalAssert_usingDefaultComparator_Test extends AbstractTemporalAssertBaseTest {
  ...
  protected ConcreteTemporalAssert invoke_api_method() {
    return assertions.usingComparator(Comparator.comparing(ZonedDateTime::toInstant))
