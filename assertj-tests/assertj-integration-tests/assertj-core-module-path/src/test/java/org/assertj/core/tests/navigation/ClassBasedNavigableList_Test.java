...
import org.assertj.core.tests.testkit.IllegalVehicleAssert;
import org.assertj.core.tests.testkit.Vehicle;
import org.assertj.core.tests.testkit.VehicleAssert;
import org.assertj.core.tests.testkit.VehicleFactory;
    ...
    assertThatExceptionOfType(RuntimeException.class).isThrownBy(() -> assertThat(expectedVehicles,
                                                                                  IllegalVehicleAssert.class)
                                                                                                             .toAssert(new VehicleFactory.Car("car"),
                                                                                                                       "unused"))
                                                     .withMessageContaining("not access a member of class org.assertj.core.tests.testkit.IllegalVehicleAssert");
  }
