 ...
 */
package org.assertj.core.tests.api.bigdecimal;
...
class BigDecimalAssert_isNotCloseTo_Test extends BigDecimalAssertBaseTest {
  ...
  protected BigDecimalAssert invoke_api_method() {
    return assertions.isNotCloseTo(other, offset);
  }

  @Override
  protected void verify_internal_effects() {
    verify(bigDecimals).assertIsNotCloseTo(getInfo(assertions), getActual(assertions), other, offset);
  }
}
