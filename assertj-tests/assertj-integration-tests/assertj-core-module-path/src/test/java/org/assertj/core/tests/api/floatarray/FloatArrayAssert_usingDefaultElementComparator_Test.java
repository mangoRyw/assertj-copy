 ...
 */
class FloatArrayAssert_usingDefaultElementComparator_Test extends FloatArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    assertThat(getArrays(assertions)).isSameAs(FloatArrays.instance());
