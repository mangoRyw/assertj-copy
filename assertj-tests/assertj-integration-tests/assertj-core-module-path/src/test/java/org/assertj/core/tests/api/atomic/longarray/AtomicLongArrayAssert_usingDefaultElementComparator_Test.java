 ...
 */
package org.assertj.core.tests.api.atomic.longarray;
...
class AtomicLongArrayAssert_usingDefaultElementComparator_Test extends AtomicLongArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    assertThat(getArrays(assertions)).isSameAs(LongArrays.instance());
  }
}
