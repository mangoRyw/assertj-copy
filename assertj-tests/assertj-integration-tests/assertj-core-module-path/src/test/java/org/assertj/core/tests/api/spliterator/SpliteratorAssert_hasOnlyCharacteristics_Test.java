 ...
 */
package org.assertj.core.tests.api.spliterator;
...
class SpliteratorAssert_hasOnlyCharacteristics_Test extends SpliteratorAssertBaseTest {
  ...
  protected SpliteratorAssert<String> invoke_api_method() {
    return assertions.hasOnlyCharacteristics(DISTINCT);
  }

  @Override
  protected void verify_internal_effects() {
    verify(spliterators).assertHasOnlyCharacteristics(getInfo(assertions), getActual(assertions), DISTINCT);
  }
