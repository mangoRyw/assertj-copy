...
class AtomicIntegerAssert_hasValueCloseTo_withinPercentage_Test extends AtomicIntegerAssertBaseTest {
  ...
  protected AtomicIntegerAssert invoke_api_method() {
    return assertions.hasValueCloseTo(10, withinPercentage(20));
  }

  @Override
  protected void verify_internal_effects() {
    verify(integers).assertIsCloseToPercentage(getInfo(assertions), getActual(assertions).get(), 10, withinPercentage(20));
  }
}
