...
/**
 * Tests for <code>{@link IntegerAssert#usingComparator(java.util.Comparator)}</code>.
 *
 * @author Joel Costigliola
 */
class IntegerAssert_usingComparator_Test extends IntegerAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    assertThat(getIntegers(assertions).getComparator()).isSameAs(comparator);
  }
}
