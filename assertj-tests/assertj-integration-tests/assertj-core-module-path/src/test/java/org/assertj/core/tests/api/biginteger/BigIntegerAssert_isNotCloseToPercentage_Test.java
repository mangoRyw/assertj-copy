 ...
 */
package org.assertj.core.tests.api.biginteger;
...
class BigIntegerAssert_isNotCloseToPercentage_Test extends BigIntegerAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(bigIntegers).assertIsNotCloseToPercentage(getInfo(assertions), getActual(assertions), value, percentage);
  }
}
