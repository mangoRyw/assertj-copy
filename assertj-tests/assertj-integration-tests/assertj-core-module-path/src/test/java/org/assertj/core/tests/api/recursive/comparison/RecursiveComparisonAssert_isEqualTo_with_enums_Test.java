...
import org.assertj.core.api.recursive.comparison.ColorDto;
import org.assertj.core.api.recursive.comparison.ComparisonDifference;
import org.assertj.core.api.recursive.comparison.Light;
import org.assertj.core.api.recursive.comparison.LightDto;
...
class RecursiveComparisonAssert_isEqualTo_with_enums_Test extends RecursiveComparisonAssert_isEqualTo_BaseTest {
  ...
  void should_fail_when_actual_is_an_enum_and_expected_is_not() {
    ...
    EmployeeDTO qaPersonDTO = new EmployeeDTO("Example Name", EmployeeDTO.JobTitle.QA_ENGINEER);
    BlogPostDTO qaBlogPostDTO = new BlogPostDTO(qaPersonDTO);
    // WHEN
    compareRecursivelyFailsAsExpected(qaBlogPostDTO, devBlogPost);
    // THEN
    ComparisonDifference difference = diff("author.jobTitle", EmployeeDTO.JobTitle.QA_ENGINEER, "SOFTWARE_DEVELOPER",
