...
class RangeSetAssert_containsAnyRangesOf_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).containsAnyRangesOf(asList(1, 2)));
    // THEN
  ...
  void should_fail_if_actual_does_not_contain_values() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).containsAnyRangesOf(values));
    // THEN
