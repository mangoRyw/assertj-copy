...
class RangeSetAssert_intersectsAnyOf_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).intersectsAnyOf(closed(0, 1)));
    // THEN
  ...
  void should_fail_if_the_given_set_does_not_intersect_ranges() {
    ...
    Range<Integer>[] ranges = array(closed(-100, 0),
                                    closed(100, 200));
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).intersectsAnyOf(ranges));
    // THEN
