...
class RangeSetAssert_containsAnyOf_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).containsAnyOf(1));
    // THEN
  ...
  void should_fail_if_actual_does_not_contain_values() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).containsAnyOf(values));
    // THEN
