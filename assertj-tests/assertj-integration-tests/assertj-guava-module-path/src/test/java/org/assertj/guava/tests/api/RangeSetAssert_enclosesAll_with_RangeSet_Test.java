...
class RangeSetAssert_enclosesAll_with_RangeSet_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).enclosesAll(rangeSet));
    // THEN
  ...
  void should_fail_if_actual_does_not_enclose_rangeSet() {
    ...
    RangeSet<Integer> expected = ImmutableRangeSet.<Integer> builder()
                                                  ...
                                                  .build();
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).enclosesAll(expected));
    // THEN
