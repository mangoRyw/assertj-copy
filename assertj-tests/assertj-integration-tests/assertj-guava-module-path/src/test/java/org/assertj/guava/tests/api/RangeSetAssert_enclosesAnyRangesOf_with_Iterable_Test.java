...
class RangeSetAssert_enclosesAnyRangesOf_with_Iterable_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).enclosesAnyRangesOf(ranges));
    // THEN
