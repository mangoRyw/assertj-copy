...
class RangeSetAssert_doesNotIntersect_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).doesNotIntersect(closed(0, 1)));
    // THEN
  ...
  void should_fail_if_actual_intersects_ranges() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).doesNotIntersect(ranges));
    // THEN
