...
class RangeSetAssert_intersects_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).intersects(closed(0, 1)));
    // THEN
  ...
  void should_fail_if_actual_does_not_intersect_ranges() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).intersects(ranges));
    // THEN
