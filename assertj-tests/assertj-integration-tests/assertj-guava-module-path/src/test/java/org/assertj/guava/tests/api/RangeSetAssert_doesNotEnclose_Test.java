...
class RangeSetAssert_doesNotEnclose_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).doesNotEnclose(closed(0, 1)));
    // THEN
  ...
  void should_fail_if_actual_encloses_ranges() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).doesNotEnclose(ranges));
    // THEN
