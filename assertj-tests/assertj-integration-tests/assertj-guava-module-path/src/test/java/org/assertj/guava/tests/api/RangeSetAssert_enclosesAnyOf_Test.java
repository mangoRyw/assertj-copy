...
class RangeSetAssert_enclosesAnyOf_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).enclosesAnyOf(closed(0, 1)));
    // THEN
  ...
  void should_fail_if_the_given_set_does_not_enclose_ranges() {
    ...
    Range<Integer>[] ranges = array(closed(0, 70),
                                    closed(120, 150));
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).enclosesAnyOf(ranges));
    // THEN
