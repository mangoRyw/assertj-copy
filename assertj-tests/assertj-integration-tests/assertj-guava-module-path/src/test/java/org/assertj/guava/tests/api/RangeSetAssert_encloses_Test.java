...
class RangeSetAssert_encloses_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).encloses(closed(0, 1)));
    // THEN
  ...
  void should_fail_if_actual_does_not_enclose_ranges() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).encloses(ranges));
    // THEN
