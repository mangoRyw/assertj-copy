...
class RangeSetAssert_containsAll_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).containsAll(values));
    // THEN
  ...
  void should_fail_if_actual_does_not_contain_values() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).containsAll(asList(3, 4, 5)));
    // THEN
