...
class RangeSetAssert_contains_Test {
  ...
  void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).contains(1));
    // THEN
  ...
  void should_fail_if_actual_does_not_contain_values() {
    ...
    // WHEN
    AssertionError error = AssertionErrors.expectAssertionError(() -> assertThat(actual).contains(values));
    // THEN
